    ...
    <section id="features" className="py-20 bg-[#F8F8F8] scroll-mt-20">
      <div className="container px-4 mx-auto max-w-6xl">
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-gradient-to-r from-white to-[#fff8f2] p-8 sm:p-12 rounded-3xl shadow-[0_0_1px_0 rgba(0,0,0,0.02)] ">
            <div className="lg:col-span-6 text-left">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <h4 className="text-base font-semibold text-amber-700 mb-4">
                ...
                <div className="p-4 sm:p-6 space-y-4 bg-white">
                  <div className="border border-amber-100 bg-white p-4 rounded-xl">
                    <div className="flex justify-between items-start mb-2">
                      <span className="font-bold text-xs bg-amber-100 text-amber-800 px-2.5 py-0.5 rounded-full">
                        Urgent
                      </span>
                    ...
                    <h5 className="font-bold text-sm text-gray-800 mb-1">
                      Algorithm Midterm Rescheduled
                    </h5>
                    <p className="text-xs text-gray-500 leading-relaxed">
                      The midterm scheduled for tomorrow has been shifted to
                      Room 502 at 2:00 PM due to a slot clash.
                    </p>
                  ...
                  <div className="border border-gray-100 bg-white p-4 rounded-xl">
                    <div className="flex justify-between items-start mb-2">
                      <span className="font-bold text-xs bg-gray-100 text-gray-600 px-2.5 py-0.5 rounded-full">
                        General
                      </span>
                      <span className="text-[11px] text-gray-400">
                        Yesterday
                    ...
                    <h5 className="font-bold text-sm text-gray-800 mb-1">
                      Guest Lecture on Cloud Solutions
                    </h5>
                    <p className="text-xs text-gray-500 leading-relaxed">
                      Department has arranged a guest seminar on Cloud
                      Infrastructure. Attendance is requested.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-gradient-to-r from-white to-[#f2faf6] p-8 sm:p-12 rounded-3xl shadow-[0_0_1px_0 rgba(0,0,0,0.02)]">
            <div className="lg:col-span-6 lg:order-2 text-left">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <h4 className="text-base font-semibold text-emerald-700 mb-4">
              ...
              <div className="w-full max-w-md bg-white rounded-2xl border border-gray-100 overflow-hidden">
                ...
                <div className="p-4 sm:p-6 space-y-3 bg-white">
                  ...
                  <div className="flex items-center gap-4 p-3 rounded-xl border border-red-100 bg-white">
                    <div className="text-center shrink-0">
                      <p className="text-xs font-bold text-gray-800 text-gray-400">
                        02:00 PM
                      </p>
                      <p className="text-[10px] text-gray-400">90 Mins</p>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-gradient-to-r from-white to-[#fff2f3] p-8 sm:p-12 rounded-3xl  shadow-[0_0_1px_0 rgba(0,0,0,0.02)]">
            <div className="lg:col-span-6 text-left">
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 rounded-lg bg-primary/10">
                  <Image
                ...
                <div>
                  ...
                  <h4 className="text-base font-semibold text-rose-700 mb-4">
                ...
                <div className="p-4 sm:p-6 space-y-4 bg-white">
                  <div className="border border-rose-100 bg-white p-4 rounded-xl">
                    ...
                    <p className="text-xs text-gray-500 mb-3">
                      Submit syntax analyzer code along with document report in
                      PDF format.
                    </p>
                  ...
                  <div className="border border-gray-100 bg-white p-4 rounded-xl">
                    ...
                    <p className="text-xs text-gray-500 mb-3">
                      Implement K-means algorithm on custom dataset. No external
                      library allowed.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-gradient-to-r from-white to-[#faf6ff] p-8 sm:p-12 rounded-3xl shadow-[0_0_1px_0 rgba(0,0,0,0.02)] ">
            <div className="lg:col-span-6 lg:order-2 text-left">
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 rounded-lg bg-primary/10">
                  <Image
                ...
                <div>
                  ...
                  <h4 className="text-base font-semibold text-purple-700 mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-gradient-to-r from-white to-[#f0fdff] p-8 sm:p-12 rounded-3xl shadow-[0_0_1px_0 rgba(0,0,0,0.02)] ">
            <div className="lg:col-span-6 text-left">
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 rounded-lg bg-primary/10">
                  <Image
                ...
                <div>
                  ...
                  <h4 className="text-base font-semibold text-cyan-700 mb-4">
                  ...
                  <div className="border border-cyan-100 bg-white p-4 rounded-xl">
                    ...
                    <div className="space-y-1.5">
                      <p className="text-xs text-gray-600 flex items-center gap-1.5">
                        <Mail className="h-3 w-3 text-cyan-700" />{" "}
                        anis@university.edu
                      </p>
