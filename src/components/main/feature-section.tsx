    ...
    <section id="features" className="py-12 sm:py-16 2xl:py-20 bg-[#F8F8F8] scroll-mt-20">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 2xl:gap-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center bg-gradient-to-r from-white to-[#fff8f2] p-5 sm:p-7 md:p-9 2xl:p-12 rounded-2xl sm:rounded-3xl shadow-[0_0_1px_0 rgba(0,0,0,0.02)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center bg-gradient-to-r from-white to-[#f2faf6] p-5 sm:p-7 md:p-9 2xl:p-12 rounded-2xl sm:rounded-3xl shadow-[0_0_1px_0 rgba(0,0,0,0.02)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center bg-gradient-to-r from-white to-[#fff2f3] p-5 sm:p-7 md:p-9 2xl:p-12 rounded-2xl sm:rounded-3xl shadow-[0_0_1px_0 rgba(0,0,0,0.02)]">
            <div className="lg:col-span-6 text-left">
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="p-2 sm:p-2.5 2xl:p-3 rounded-lg bg-primary/10">
                  <Image
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center bg-gradient-to-r from-white to-[#faf6ff] p-5 sm:p-7 md:p-9 2xl:p-12 rounded-2xl sm:rounded-3xl shadow-[0_0_1px_0 rgba(0,0,0,0.02)]">
            <div className="lg:col-span-6 lg:order-2 text-left">
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="p-2 sm:p-2.5 2xl:p-3 rounded-lg bg-primary/10">
                  <Image
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center bg-gradient-to-r from-white to-[#f0fdff] p-5 sm:p-7 md:p-9 2xl:p-12 rounded-2xl sm:rounded-3xl shadow-[0_0_1px_0 rgba(0,0,0,0.02)]">
            <div className="lg:col-span-6 text-left">
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="p-2 sm:p-2.5 2xl:p-3 rounded-lg bg-primary/10">
                  <Image
