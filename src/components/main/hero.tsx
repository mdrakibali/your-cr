  ...
  return (
    <section className="relative overflow-hidden bg-primary/10 py-16 lg:py-20">
      <div className="container flex flex-col items-center text-center">
        ...
        <h1 className="text-2xl sm:text-4xl lg:text-[50px] font-medium text-[#333333] leading-[1.2]">
          Simplify Class Management <br />{" "}
          <span className="italic text-primary">with Your CR</span>
        </h1>
        {/* Description */}
        <p className="mt-6 max-w-3xl text-sm sm:text-base md:text-lg lg:text-[19px] leading-relaxed text-gray-500">
