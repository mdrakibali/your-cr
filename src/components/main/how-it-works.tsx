    ...
    switch (activeStep) {
        ...
        return (
          <div className="flex flex-col items-center justify-center p-6 h-full space-y-4">
            <div className="border border-gray-200 bg-white rounded-xl p-5 w-full max-w-xs text-left">
              <h5 className="font-bold text-xs text-gray-400 uppercase mb-2">
            ...
            <div className="border border-emerald-100 bg-emerald-50/10 rounded-xl p-5 w-full max-w-xs text-left">
              ...
              <p className="text-[10px] text-gray-500 mt-2">
                You can now add student lists and manage schedules.
              </p>
            </div>
          </div>
        );
      case 2:
        return (
          <div className="flex flex-col items-center justify-center p-6 h-full space-y-4">
            <div className="border border-gray-200 bg-white rounded-xl p-5 w-full max-w-xs text-left">
              <h5 className="font-bold text-xs text-gray-800 mb-3">
                Add Student
              </h5>
              <div className="space-y-2 text-xs">
                <div>
                  ...
                  <div className="border border-gray-200 rounded p-1.5 bg-gray-50 text-gray-600">
                    fahim@university.edu
                  </div>
                </div>
                <div>
                  <label className="text-[10px] font-semibold text-gray-400">
            ...
            <div className="border border-blue-100 bg-blue-50/20 rounded-xl p-4 w-full max-w-xs text-left">
              ...
              <p className="text-[10px] text-gray-500 leading-relaxed">
                ...
                <br />
                "You've been added to YourCR. Click here to login using your
                roll..."
              </p>
            </div>
          </div>
            ...
            <div className="border border-gray-200 bg-white rounded-xl p-5 w-full max-w-xs text-left">
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center bg-gray-50 cursor-pointer">
                ...
                <span className="text-[9px] text-gray-400">
                  PDF, WebP, SVG, PNG or Doc (Max 10MB)
                </span>
              </div>
        ...
        <div className="mt-8 sm:mt-10 2xl:mt-12 text-center">
          <Link href="/register">
            <Button className="h-10 sm:h-11 2xl:h-12 px-5 sm:px-6 text-xs sm:text-sm font-semibold 2xl:font-bold bg-primary text-white rounded-lg inline-flex items-center justify-center gap-2 hover:bg-primary/95 transition-colors cursor-pointer">
              Register Your Class CR Session <ArrowRight className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
            </Button>
          </Link>
        </div>
      </div>
